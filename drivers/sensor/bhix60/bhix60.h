...
enum sensor_channel_bhix60 {
  ...
  SENSOR_CHAN_BHIX60_STC_HW	        = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_STC_HW	,	/* Hardware Step counter */
  SENSOR_CHAN_BHIX60_STD_HW	        = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_STD_HW	,	/* Hardware Step detector */
  SENSOR_CHAN_BHIX60_SIG_HW	        = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_SIG_HW	,	/* Hardware Significant motion */
  SENSOR_CHAN_BHIX60_STC_HW_WU	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_STC_HW_WU,	/* Hardware Step counter wake up */
  SENSOR_CHAN_BHIX60_STD_HW_WU	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_STD_HW_WU,	/* Hardware Step detector wake up */
  SENSOR_CHAN_BHIX60_SIG_HW_WU	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_SIG_HW_WU,	/* Hardware Significant motion wake up */
  SENSOR_CHAN_BHIX60_ANY_MOTION	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_ANY_MOTION,	/* Any motion */
  SENSOR_CHAN_BHIX60_ANY_MOTION_WU	= SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_ANY_MOTION_WU,   /* Any motion wake up */
  ...
  SENSOR_CHAN_BHIX60_MULTI_TAP	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_MULTI_TAP,	/* Multi-tap detector (wear/hear) */
  SENSOR_CHAN_BHIX60_ACTIVITY	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_ACTIVITY	,	/* Activity recognition (wear/hear) */
  SENSOR_CHAN_BHIX60_WRIST_GEST	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_WRIST_GEST,	/* Wrist gesture */
  SENSOR_CHAN_BHIX60_WRIST_WEAR_WU	= SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_WRIST_WEAR_WU,   /* Wrist wear wake-up */
  SENSOR_CHAN_BHIX60_NO_MOTION	    = SENSOR_CHAN_PRIV_START +	BHY2_SENSOR_ID_NO_MOTION,	/* No motion detector */
