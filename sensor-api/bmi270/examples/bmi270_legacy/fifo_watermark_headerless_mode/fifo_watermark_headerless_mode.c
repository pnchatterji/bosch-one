...
#define BMI270_LEGACY_FIFO_RAW_DATA_BUFFER_SIZE  UINT16_C(800)

/*! Length of data to be read from FIFO */
#define BMI270_LEGACY_FIFO_RAW_DATA_USER_LENGTH  UINT16_C(800)
 ...
 */
#define BMI270_LEGACY_FIFO_ACCEL_FRAME_COUNT     UINT8_C(55)

/*! Number of gyro frames to be extracted from FIFO */
#define BMI270_LEGACY_FIFO_GYRO_FRAME_COUNT      UINT8_C(55)

/*! Setting a watermark level in FIFO */
#define BMI270_LEGACY_FIFO_WATERMARK_LEVEL       UINT16_C(650)
...
int main(void)
{
    ...
    uint16_t accel_frame_length = BMI270_LEGACY_FIFO_ACCEL_FRAME_COUNT;
    ...
    fifoframe.length = BMI270_LEGACY_FIFO_RAW_DATA_USER_LENGTH;
    ...
    fifoframe.wm_lvl = BMI270_LEGACY_FIFO_WATERMARK_LEVEL;
    ...
    while (try <= 10)
    {
        ...
        if ((rslt == BMI2_OK) && (int_status & BMI2_FWM_INT_STATUS_MASK))
        {
            ...
            accel_frame_length = BMI270_LEGACY_FIFO_ACCEL_FRAME_COUNT;
            gyro_frame_length = BMI270_LEGACY_FIFO_GYRO_FRAME_COUNT;
