...
#define BMI2_FIFO_RAW_DATA_BUFFER_SIZE  UINT16_C(4500)

/*! Length of data to be read from FIFO */
#define BMI2_FIFO_RAW_DATA_USER_LENGTH  UINT16_C(4500)

/*! Number of accel frames to be extracted from FIFO */

/*!
 * Calculation:
 * fifo_watermark_level = 4050, accel_frame_len = 6, gyro_frame_len = 6, aux_frame_len = 8.
 * fifo_accel_frame_count = (4050 / (6 + 6 + 8 )) = 192 frames
 */
#define BMI2_FIFO_ACCEL_FRAME_COUNT     UINT16_C(192)

/*! Number of gyro frames to be extracted from FIFO */
#define BMI2_FIFO_GYRO_FRAME_COUNT      UINT16_C(192)

/*! Number of aux frames to be extracted from FIFO. */
#define BMI2_FIFO_AUX_FRAME_COUNT       UINT16_C(192)
