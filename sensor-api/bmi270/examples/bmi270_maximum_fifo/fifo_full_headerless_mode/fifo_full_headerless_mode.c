...
/*! Calculation for frame count: Total frame count = Fifo buffer size(6144)/ Total frames(6 Accel, 6 Gyro totaling to
 * 12) which equals to 512.
 */

/*! Number of accel frames to be extracted from FIFO */
#define BMI2_FIFO_ACCEL_FRAME_COUNT     UINT16_C(512)

/*! Number of gyro frames to be extracted from FIFO */
#define BMI2_FIFO_GYRO_FRAME_COUNT      UINT16_C(512)
